...
public class ProductControllerTest {
    ...
    public void getProduct_notFound() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/products/{productId}", 20000);
        mockMvc.perform(requestBuilder).andExpect(status().is(404));
    }

    // 創建商品
    @Transactional // 復原資料庫測試改動
    @Test
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.results", hasSize(5)))
                .andExpect(jsonPath("$.results[0].productId", equalTo(36)))
                .andExpect(jsonPath("$.results[1].productId", equalTo(35)))
                .andExpect(jsonPath("$.results[2].productId", equalTo(37)))
                .andExpect(jsonPath("$.results[3].productId", equalTo(34)))
                .andExpect(jsonPath("$.results[4].productId", equalTo(32)));
    }
    ...
    public void getProducts_pagination() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.results", hasSize(2)))
                .andExpect(jsonPath("$.results[0].productId", equalTo(35)))
                .andExpect(jsonPath("$.results[1].productId", equalTo(34)));
    }
}
